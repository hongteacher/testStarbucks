[![스타벅스](./images/starbucks_logo.png)](https://hongteacher.github.io/testStarbucks/)

[해당페이지로 이동](https://hongteacher.github.io/testStarbucks/)
...
### 2. SEO (검색엔진 최적화)
구글이나 네이버 등에 자신의 웹 사이트/페이지를 노툴할 수 있도록 정보를 최적화하는 작업을 말한다.
```html
